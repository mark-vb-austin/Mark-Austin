      ...
      <article className='post-content page-template no-image'>
        <div className='post-content-body'>
          ...
          <p>
            ...
            . This is <sup>superscript</sup>text and this is <sub>subscript</sub> text. This is <u>underlined</u> and this is code:{" "}
            <code>
              for (;;) {"{"} ... {"}"}
            </code>
          ...
          <figure className='kg-card kg-image-card'>
            <GatsbyImage image={getImage(post.frontmatter.thumbnail)} className='kg-image' alt={post.frontmatter.title} />
